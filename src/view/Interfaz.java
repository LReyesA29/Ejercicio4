...
public class Interfaz {
    ...
    if (ruleRepeat == null) {
        ...
        if ("1".equals(value)) {
            ...
            System.out.println("Valor inválido para FILTER_REPEAT: " + value + " no se realizan cambios (Desactivada)");
        } else {
...
private void rule_FILTER_ID_CLIENT() {
    ...
    if (listFilter.isEmpty()) {
        System.out.println("No hay transacciones con el ID cliente: " + clientId);
        handlingPersistence.setListFilterTransactions(new ArrayList<>());
        return;
    }
...
private void rule_FILTER_REPEAT() {
    ...
    String value = rule.getValue() != null ? rule.getValue().trim() : "0";
